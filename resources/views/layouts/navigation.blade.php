        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('home') }}">
                        <span class="text-xl font-bold text-gray-800">Career Portal</span>
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                        ...
                        <x-slot name="content">
                            @auth
                                @if(auth()->user()->role === 'applicant')
                                    <x-dropdown-link :href="route('applicant.dashboard')">
                                        {{ __('Profile') }}
                                    </x-dropdown-link>
                                @endif
                            @endauth
                ...
                @else
                    ...
                    <a href="{{ route('register') }}" class="ms-4 text-gray-600 hover:text-gray-900">
                        {{ __('Register') }}
                    </a>
                @endauth
            </div>
